...
//BEGIN of VertexNode    
    ...
    public:
        ...
        DLinkedListSE<T> getOutwardEdges(){
            DLinkedListSE<T> list;
...
/*
DLinkedList<char> list = graph.getOut
